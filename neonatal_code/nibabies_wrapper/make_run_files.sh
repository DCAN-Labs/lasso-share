...
tmp_dir="/tmp"
segs_dir="/projects/standard/csandova/shared/projects/rae_neonatal/derivatives/corrected_segmentations"
bids_dir="/projects/standard/csandova/shared/projects/rae_neonatal/derivatives/nordic"
...
process_folder="${run_folder}/run_files.nibabies"
...
cat ${subject_list} | while read line; do
	sed -e "s|SUBID|${line}|g" -e "s|SESID|${ses}|g" -e "s|DATADIR|${tmp_dir}|g" -e "s|SEGS|${segs_dir}|g" -e "s|INPUT|${bids_dir}|g" -e "s|OUTPUT|${output_dir}|g" -e "s|RUNDIR|${run_folder}|g" ${run_folder}/${process_template} > ${process_folder}/run${k}
