...
#SBATCH -o /projects/standard/lewi1538/shared/projects/neg_urg/output_logs/nordicsbatch_%A.out
#SBATCH -e /projects/standard/lewi1538/shared/projects/neg_urg/output_logs/nordicsbatch_%A.err
#SBATCH -A faird
