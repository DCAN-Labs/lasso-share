...
deriv_dir="/projects/standard/lewi1538/shared/projects/neg_urg/derivatives/xcpd"
...
# Loop through list of subjects to create run files, use specified ses_id
while IFS=',' read -r subid rest_of_line; do
